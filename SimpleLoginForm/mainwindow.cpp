    ...
    : QMainWindow(parent)
{
    ...
    l->move(100,50);
    QPixmap p("F:/6TH SEM/C++/simpleloginform/login.png");
    l->setPixmap(p.scaled(20,20));

    QLabel *lb=new QLabel(this);
    lb->move(180,25);
    lb->setAlignment(Qt::AlignHCenter);
    QPixmap pi("F:/6TH SEM/C++/simpleloginform/username.png");
    ...
    QPixmap pix("F:/6TH SEM/C++/simpleloginform/password.png");
